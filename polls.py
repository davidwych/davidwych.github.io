polls = {
    ...
    'govt_reg_2016' : ('Level of government regulation (2016)',
                           "In general, do you think there is ... regulation of business by the government?",
                           [[1],[2],[3],[8]],
                           ['Too Much', 'About the right amount','Too little', 'Don\'t Know']),
    ...
    'educ_basline' : ('Education',
                      "What is the highest level of education you have completed?",
                      [[1],[2],[3,4,5],[6]],
                      ['No HS', 'High School', 'Some college', 'Post Grad']),


    'employstat2_basline' : ('Employment Status',
                             "What is your employment status?",
                             [[1],[2],[3],[4],[5],[6],[7],[8]],
                             ['Full-time employed','Part-time employed','Self-employed','Unemployed or temporarily laid off','Retired','Permanently disabled','Homemaker','Other']),
    ...
    'faminc_baseline' : ('Family Income',
                         ...
                         ['Up to 30k', '30-50k', '50-100k','100-150k', '150k and above', 'Prefer not to say']),
    ...
    'presvote16post_2016' : ('2016 Presidential Vote',
                             ...
                             [[1],[2],[3, 4, 5, 6, 7]],
                             ['Hillary Clinton', 'Donald Trump', 'Other/Didn\'t Vote']),
    ...
    'ft_muslims_2016' : ('Feelings about Muslims',
