...
- **Advisor/PI**: David L. Mobley (Chem. and Pharm. Sci.)

- **Mentor**: Michael E. Wall (CCS-3; LANL)
...
- [Published work](https://aca.scitation.org/doi/10.1063/1.5132692) in *Structural Dynamics* which used MD simulations to characterize correlated disorder in protein crystals, to predict the diffuse scattering in XRC, and to provide context to a long-standing debate about the main source of diffuse scattering (selected as a [SciLight](https://aip.scitation.org/doi/10.1063/10.0000388) by the American Institute of Physics [AIP])
