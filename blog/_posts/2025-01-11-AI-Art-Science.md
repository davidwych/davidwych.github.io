...
> If an A.I. generates a ten-thousand-word story based on your prompt, it has to fill in for all of the choices that you are not making.… Real paintings bear the mark of an enormous number of decisions. By comparison, a person using a text-to-image program like DALL-E enters a prompt such as “A knight in a suit of armor fights a fire-breathing dragon,” and lets the program do the rest…. Most of the choices in the resulting image have to be borrowed from similar paintings found online; the image might be exquisitely rendered, but the person entering the prompt can’t claim credit for that.
 ...
 It’s fashionable to say that AI/ML products are artistically hollow because they represent only a prompt-guided probabilistic average of all the art they’ve ingested. But it’s not this property that drains the outputs of artistic value — a lot of human art is some kind of weighted combination of influences. To my mind, it’s not even that the AI/ML tool isn’t making any choices. As Chiang says, their purpose is to fill in for all the choices you’re not making.
 
 Rather, their artistic output is hollow because *they have no taste*. Or, what taste they’ve been trained to have suggests only an aesthetic preference for the innocuous (for obvious legal and economic reasons). They have no aesthetic principles. There is nothing they’re aspiring to be, or not to be, because they’re aspiring to be anything. To make anything of true artistic value with these tools, one would have to supply the algorithms with prompts of such specificity, such care, such discrimination and understanding of the algorithms' intricacies and limitations, that the prompt in itself becomes the artistic product, not the models' output. 
 
 To be sure, some artists are making work of this kind with AI/ML tools. But this style of engagement with the product is not what's advertised. These companies are selling microwaves, and sure, it's possible to create food of genuine skill and personal expression using microwaves, but the marketing materials promise gorgeous, succulent, satisfying meals for the whole family at the touch of a button.
...
ChatGPT is a text prediction machine, masquerading as an interlocutor. In real conversation, an answer to question isn’t a puzzle to solve, it’s an invitation to conversation. Sometimes the right answer to a question is another, better question. 

A better question might have been "what's the opposite of making choices?". Maybe “taking direction”?

Is science “the result of taking direction”? A good scientist takes direction from the way the universe behaves. Revisions of scientific theories happen when we take direction from Mother Nature: when she doesn’t conform to our models of Her, we update the models. This definition is probably better than the one involving reducing choice, but it would require that the AI understand the *intention* of the question, and to respond with intention -- not just play a word game, but play with ideas.
...
Like the practice of art, scientific practice has aesthetics — choice we make about how to conduct scientific inquiry —  principles that are not dictated by evidence, logic, or necessity *per se* but are no less important. A simpler model is preferable to complex one, even if both take direction from Mother Nature: the Ptolemaic model of the solar system could have been continually adapted, to arbitrary accuracy, but the Galilean or Keplerian model was better because *it didn’t need to be continuously adapted*. We prefer the latter to the former, in a very real sense, as purely a matter of aesthetic preference — as a matter of taste — but this preference serves us well.
...
> 
> The Oracle’s predictions never seemed to err, so long as she was satisfied with the offerings and had been provided with sufficient observations (they had learned this latter requirement the hard way). She seemed, for all the people knew, to be in complete command of the laws of the Gods. They were totally reliant on her, but she served them so well they didn’t mind: their society had only become more healthy and prosperous as they served and queried her. 
> 
...
> 
> More mysteriously, they found she never seemed to want to render explanations. She could only tell them *what* she knows, not *how* she knows it. She had operated in this way for so long, they no longer even thought to ask her how she knew what she knew. Her prescriptions and predictions themselves were evidence enough that, somehow, she knew.
> 
> The society that had sprung up in this ancient city was advanced but strange: intricate, well crafted buildings housed countless scribes whose only concerns were cataloguing everything one could think to catalogue -- some scribes dedicated years of their life to counting and tabulating their heartbeats, others watched their colleagues sleep and recorded their respiratory rate and sleep disturbances. Their water arrived by sophisticated carts of stacked cubes made of sheep skin — the oracle had revealed that a cube was the most efficient shape for transport; they had never thought to ask about more efficient ways to transport water down the mountain.

Can we say that this ancient people was doing science? Though they’re doing it through a proxy, they’re still taking direction from the laws of Nature, are they not? Their choices are limited with phenomenal efficiency by her inerrant responses. Their model of the universe has but one simple component, and it is her.

What they fail to do is endeavor to *understand*. Understanding doesn’t consist in simply getting answers to questions, but in refining what questions to ask. This is, fundamentally, how science progresses. We no longer have to ask questions about phlogiston, because we understand that it doesn’t exist. We could ask as many questions as we like about what substance ghosts are made of, but we’d be wasting our time.

This is the reason why “a theory of everything is a theory of nothing.” A model that captures everything captures nothing in particular. It doesn’t help to explain because explanation requires reduction, not just in the answers it gives but in what questions it allows for in the first place. “That’s just the way it is,” is a good explanation for everything, but a terrible explanation for anything in particular.

Deep neural networks aren’t really all that different from the Oracle. They require vast resources, have inexhaustible data requirements, and encompass a model of the phenomena they model that is so convoluted and inscrutible it’s unreasonable to even ask how they "know" what they "know". Seemingly without irony, major AI companies have adopted a the technique of teasing apart the "concepts" in their Large Language Models' weights using — I kid you not — [more deep neural networks](https://transformer-circuits.pub/2024/scaling-monosemanticity/index.html).
...
Levinthal's paradox refers to a seemingly insurmountable problem in the science of protein folding. Proteins are the biological machines that do the work of... well, everything that needs to get done in a living thing. They contract and expand to power muscles, they digest our food, they block and shuttle ions across our cell membranes to pass along signals in our brains. Proteins are composed of long chains of amino acids: molecules of different sizes, shapes, and properties that click together like little modules to form tiny molecular machines. Click any significant number of these animo acids together and the number of different configurations these molecules can be found in becomes incomprehensibly vast: assuming each amino acid can adopt one of 3 different poses (an extremely conservative assumption) a 200 amino acid protein (small, but reasonable as an illustrative case) can adopt 3^200 different conformations. There are 4 quadrillion possible configurations for this small-ish protein for every atoms in the observable universe.

*Protein folding is an extremely hard problem.* 

The crux of Levinthal's paradox is not even how quixotic it might be for humans to ever predict the structure that a given protein folds in to, but how the *protein's themselves* could ever actually fold in to their specific shapes, so consistently, given the number of different possible configurations. This is a seemingly miraculous trick that mother nature pulls, and our lives depend on it happening quadrillions of times a second.

AlphaFold is the brand name for a series of protein structure prediction algorithms by Google's DeepMind that have genuinely revolutionized structural biology. If you read the popular science press you may have heard that DeepMind has "solved the protein folding problem" (reader, I'll just have to ask you trust me: they have not). The Nobel Prize recently awarded to these advances was controversial, but I don't think any scientist could convincingly minimize the gravity of the accomplishment (at the very last as an *engineering* achievement). Given any sequence of amino acids, AlphaFold can provide a reasonably good guess at how the protein composed of that sequence of amino acids will fold.

This is the kind of thing neural networks were made for: whatever function we can imagine that would take in a sequence of amino acids and output an array of atomic coordinates for the protein corresponding to that sequence is bound to be extremely complicated; so complicated that even imagining a symbolic mathematical model for it exhausts the mind. But that doesn't matter, neural networks can approximate it. This problem also has the benefit of being extremely well-constrained, and (owing to the thankless work of thousands of graduate students, post docs, and professional scientists across decades) we have a large database called the Protein Data Bank of extremely high quality, free, open access protein structure data to train on.

Natural language text prediction is a similarly well-constrained problem (the alphabet isn't going to surprise us and add a thousand of new characters tomorrow), and the internet provided what at first appeared to be more data than we could have ever wished for. Which is not to say the problem is *easy*, only that it's well-suited for a neural network. The kinds of problems that don't (yet) appear to be well-suited to neural networks are un-constrained and/or data-limited -- the kinds of things children and young adults excel at learning: things like object manipulation, task generalization, and spatial or physical understanding.

But, even if we were to eventually build neural networks that can perform on par with humans at *all* of these problems, the question from a scientific standpoint is "what have we learned?" What do we understand now, that we didn't before? What new questions can we ask, that we couldn't even think to ask before?

When it comes to protein folding, I'm not sure I can say that AlphaFold gives us a new or better *understanding* of protein structure, or the protein folding problem. I'm not sure what the model *teaches* us. I'm not sure what we've *learned* other than: "a computer can predict protein structure pretty well". Again, this is an astonishing achievement, but in the list of things we've learned about the Universe and the Laws of Nature, this insight is pretty uninspiring.

We can say much the same about Large Language Models: it is astonishing that computers can be wrangled in to producing such an uncanny and seemingly expert command of language and the information it conveys. But can we say that these models have taught us anything about language and meaning? Can we even imagine how they would teach us anything about language and meaning? Perhaps. But given that even State of the Art models still seem to struggle with counting how many "R"s are in the word Strawberry, I have my doubts -- and I think those who make excuses or play defense for these models are doing more wishful, motivated reasoning than rigorous, first-principles forecasting.
...
Art is a means to understanding ourselves and each other more deeply. But do we care? Or will it be enough to give us the power to speak or type to our devices, and let them produce a simulacra of this for us? It is no doubt going to be cheaper, faster, and easier.
